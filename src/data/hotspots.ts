...
export const HOTSPOTS: Hotspot[] = [
  {
    ...
    type: 'terrestrial',
    barangay: 'San Isidro / Governor Generoso / Mati City',
    city: 'Mati City',
    province: 'Davao Oriental',
    designation: 'UNESCO World Heritage Site • Protected Area (RA 9303)',
    areaHectares: 6834,
    lat: 6.814,
    lng: 126.168,
    elevationRangeMeters: [75, 1637],
    summary: 'Globally important mountain massif with mossy-pygmy forests and exceptionally high endemism.',
    description:
      'Mount Hamiguitan hosts ultramafic soils that foster bonsai "pygmy" forests alongside dipterocarp stands and montane mossy habitats. Its elevational gradient shelters species found nowhere else on Earth, including critically endangered raptors and carnivorous pitcher plants.',
    features: [
      'UNESCO Outstanding Universal Value citation (2014)',
      'Bonsai forest featuring dwarfed 100-year-old trees',
      'Nested zones of dipterocarp, montane and mossy forests',
      'Habitat for globally threatened vertebrates and endemic flora',
    ],
    stewardship:
      'Protected area management board with DENR-BMB, Davao Oriental LGUs, indigenous Mandaya/Kaagan communities, and scientific partners.',
    image: 'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1200&q=80',
    tags: ['UNESCO', 'Endemism', 'Montane forest', 'Pygmy forest'],
    highlightSpeciesIds: [
      'philippine-eagle',
    ...
    faunaIds: [
      ...
      'hamiguitan-tree-frog',
    ],
    visitorNotes:
      'Visitor access is regulated; research and trekking require permits from the Protected Area Management Board.',
  },
  {
    id: 'pujada-bay',
    name: 'Pujada Bay Protected Seascape',
    type: 'marine',
    barangay: 'Central coastal barangays of Mati City',
    city: 'Mati City',
    province: 'Davao Oriental',
    designation: 'Declared Protected Seascape (Presidential Proclamation No. 431)',
    areaHectares: 44794,
    lat: 6.955,
    lng: 126.234,
    summary: 'Productive bay with coral gardens, seagrass beds, extensive mangroves, and migratory megafauna.',
    description:
